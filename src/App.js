    ...
    <>
      ...
      <div className="p-10 bg-[#deeded]">
        <nav className="mb-16 space-y-4">
          ...
          {statsDropdown && (
            <div className="ml-[65%] z-10 border-2 border-black">
              <div className="p-6">
          ...
          {searchArr && (
            ...
            >
              <button onClick={toggleModel} className="">
                <div className="my-4">
                  <img
                    src={`https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/dream-world/${searchArr.url.charAt(
                      34
                    )}.svg`}
                    height="150px"
                    width="150px"
                ...
                <div className="text-center pb-4 flex flex-col">
                  ...
                  <span>{searchArr.url && searchArr.url.charAt(34)}</span>
                </div>
              </button>
            </div>
          )}
